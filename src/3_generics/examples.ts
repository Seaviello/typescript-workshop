...
const getPersonProperty = <K extends personProperties>(obj: Person, key: K, fallback: Person[K]) =>
  obj[key] || fallback;

const maybeGetProperty = <T, K extends keyof T>(obj: T, key: K, fallback: T[K]) => obj[key] || fallback;
...
const getProperty = <T, K extends keyof T>(obj: T, key: K, fallback: Required<T>[K]) => obj[key] || fallback;
